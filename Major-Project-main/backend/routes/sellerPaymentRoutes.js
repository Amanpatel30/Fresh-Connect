...
router.get('/transactions', protect, sellerOnly, async (req, res) => {
  try {
...
// @access  Private/Seller
router.get('/summary', protect, sellerOnly, async (req, res) => {
  try {
    const sellerId = req.user._id;
...
// @access  Private/Seller
router.get('/transactions/:id', protect, sellerOnly, async (req, res) => {
  try {
...
// @access  Private/Seller
router.post('/request-payout', protect, sellerOnly, async (req, res) => {
  try {
    const sellerId = req.user._id;
