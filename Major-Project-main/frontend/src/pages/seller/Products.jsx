      ...
      <Box sx={{ p: 3 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                ...
                <Typography variant="h4" sx={{ my: 1, fontWeight: 800, color: '#3b82f6' }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                ...
                <Typography variant="h4" sx={{ my: 1, fontWeight: 800, color: '#f59e0b' }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                ...
                <Typography variant="h4" sx={{ my: 1, fontWeight: 800, color: '#ef4444' }}>
          ...
          >
            ...
            <Collapse in={showFilters || (searchQuery || categoryFilter !== 'all' || stockStatusFilter !== 'all')}>
              ...
              <Grid container spacing={2} sx={{ mt: 1 }}>
                ...
                <Grid item xs={12} sm={8} md={9}>
                  ...
                  {(searchQuery || categoryFilter !== 'all' || stockStatusFilter !== 'all') && (
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, height: '100%', alignItems: 'center' }}>
                      {searchQuery && (
                        <Chip 
        ...
        <Box sx={{ mt: 4 }}>
          ...
          <Paper 
            ...
            sx={{ 
              ...
              border: '1px solid rgba(0, 0, 0, 0.08)',
              boxShadow: '0 4px 12px rgba(0, 0, 0, 0.03)',
              bgcolor: selectedProducts.length > 0 ? 'rgba(59, 130, 246, 0.05)' : 'white',
              transition: 'all 0.3s ease',
              '&:hover': {
                boxShadow: '0 8px 24px rgba(0, 0, 0, 0.08)',
              }
                  ...
                  >
                    <Card 
                      ...
                      sx={{ 
                        ...
                        flexDirection: 'column',
                        height: '100%',
                        minHeight: 350, // Further reduced from 380
                        borderRadius: 3,
                        border: '1px solid rgba(0, 0, 0, 0.08)',
                        position: 'relative',
                        overflow: 'hidden',
                    ...
                    >
                      ...
                      <Box sx={{ 
                        paddingTop: '75%', // Creates a 4:3 aspect ratio
                        position: 'relative',
                        width: '100%',
                        overflow: 'hidden',
                      }}>
                      ...
                      <CardContent sx={{ 
                        ...
                        flexDirection: 'column',
                        justifyContent: 'space-between',
                        '&:last-child': { pb: 0.5 } // Override MUI default padding
                      }}>
                        <Box>
                        ...
                        <Box>
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Box>
                              <Typography variant="h6" color="#3b82f6" sx={{ fontWeight: 700, mb: 0.25, fontSize: '1rem' }}>
                ...
                <Grid item xs={12} key={product._id}>
                  ...
                  >
                    <Card elevation={0} sx={{ 
                      ...
                      <Box sx={{ 
                        ...
                        <CardContent sx={{ 
                          ...
                          <Box sx={{ mb: 0.75 }}>
                            ...
                            <Typography variant="subtitle1" fontWeight={700} color="#2c3e50" sx={{ 
                              mb: 0.5,
                              fontSize: '0.95rem',
                              overflow: 'hidden',
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Box>
                              <Typography variant="h6" color="#3b82f6" sx={{ fontWeight: 700, mb: 0.25, fontSize: '0.95rem' }}>
                                ₹{product?.price}/{product?.unit}
                              </Typography>
                              <Typography variant="caption" color="#64748b" sx={{ fontSize: '0.7rem' }}>
                                Stock: {product?.stock} {product?.unit}
                      ...
                      <Box sx={{ position: 'absolute', top: 8, right: 60, zIndex: 2, display: 'flex', gap: 0.5 }}>
                        {product.stock === 0 && (
                          <Chip
                            label="Out of Stock"
                            size="small"
