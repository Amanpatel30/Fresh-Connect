      ...
      <AppBar position="sticky" sx={{ 
        ...
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <IconButton component={Link} to="/profile?tab=wishlist" color="inherit" sx={{ mx: 1 }}>
      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={2}>
            ...
            <Link to="/profile?tab=wishlist" style={{ textDecoration: 'none' }}>
              <Typography variant="body2" color="text.secondary" paragraph>
                Wishlist
              </Typography>
            </Link>
            <Link to="/profile?tab=settings" style={{ textDecoration: 'none' }}>
              <Typography variant="body2" color="text.secondary" paragraph>
                Settings
              </Typography>
            </Link>
...
const Wishlist = () => {
  ...
  const handleAddToCart = async (item) => {
    try {
      ...
      notification.error(error.response?.data?.message || 'Failed to add item to cart');
    }
  };
