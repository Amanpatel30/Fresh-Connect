...
export const uploadProductImages = async (id, formData) => {
  try {
    const response = await api.post(`/api/seller/products/${id}/images`, formData, {
      headers: {
...
export const getFeaturedProducts = async () => {
  try {
    const response = await api.get('/api/seller/products/featured');
    return response.data;
  } catch (error) {
...
export const toggleFeaturedStatus = async (id) => {
  try {
    const response = await api.patch(`/api/seller/products/${id}/featured`);
    return response.data;
  } catch (error) {
...
export const bulkUpdateProducts = async (productIds, updateData) => {
  try {
    const response = await api.patch('/api/seller/products/bulk-update', {
      productIds,
      updateData
    });
    return response.data;
