...
import * as urgentSaleController from '../controllers/urgentSaleController.js';
...
router.get('/orders/stats', dashboardController.getSalesData);

// Urgent sale routes
router
  .route('/urgent-sales')
  .get(urgentSaleController.getUrgentSales)
  .post(urgentSaleController.createUrgentSale);

// Comment out this line as getUrgentSaleStats doesn't exist in the controller
// router.get('/urgent-sales/stats', urgentSaleController.getUrgentSaleStats);

router
  .route('/urgent-sales/:id')
  .get(urgentSaleController.getUrgentSale)
  .patch(urgentSaleController.updateUrgentSale)
