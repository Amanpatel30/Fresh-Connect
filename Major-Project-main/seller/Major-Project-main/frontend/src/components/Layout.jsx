...
const menuItems = [
  ...
  { text: 'Products', icon: <ProductsIcon />, path: '/seller/products' },
  { text: 'Orders', icon: <OrdersIcon />, path: '/seller/orders' },
  { text: 'Urgent Sales', icon: <UrgentSalesIcon />, path: '/seller/urgent-sales' },
  { text: 'Profile', icon: <ProfileIcon />, path: '/seller/profile' },
  { text: 'Reviews', icon: <ReviewsIcon />, path: '/seller/reviews' },
  { text: 'Payments', icon: <PaymentsIcon />, path: '/seller/payments' },
  { text: 'Verification', icon: <VerificationIcon />, path: '/seller/verification' },
];
